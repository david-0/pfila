...
export class SchemaMigration1704925858702 implements MigrationInterface {
    name = 'SchemaMigration1704925858702'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "notification" boolean NOT NULL DEFAULT false`);
